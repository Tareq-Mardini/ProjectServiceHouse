...
class SendClientMessageToAdmin implements ShouldBroadcastNow
{
    ...
    {
        return new Channel('ClientToAdmin');
    }
    ...
    {
        $client = Client::find($this->message->sender_id);
