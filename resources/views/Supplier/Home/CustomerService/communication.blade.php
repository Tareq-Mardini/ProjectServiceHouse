    ...
    <section id="content">
        ...
        <main style="padding:0px ;margin:0px;max-height: 598px;min-height: 598px;">
            ...
            <script>
                ...
                const channel = pusher.subscribe('AdminToSupplier');
                channel.bind('AdminSupplier-message', function(data) {
                    console.log('Received message:', data);
                    // التحقق من أن الرسالة موجهة لنا
                    if (supplierId == data.receiver_id && data.role == 'supplier') {
                ...
                document.getElementById('send-message-form').addEventListener('submit', function(event) {
                    ...
                    // Send the data
                    fetch('/send-message-Supplier-To-Admin', {
                            method: 'POST',
                            body: formData,
                            headers: {
