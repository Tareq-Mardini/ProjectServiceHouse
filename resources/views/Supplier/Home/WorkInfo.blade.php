                ...
                <div class="small-box">
                    ...
                    <div class="product-details">
                        ...
                        <div class="portfolio-btn-container" style="text-align: center; margin-top: 20px;">
                            <a href="{{ route('view.portfolio.user', ['id' => $works->Supplier->id]) }}"
                                class="portfolio-btn">
                ...
                <div class="extra-offers-section discription detail" style="flex: 1; min-width: 300px; border-radius: 15px; padding: 15px;">
                    ...
                    <div class="extra-offer-box" style="border: 1px solid #ddd; padding: 15px; border-radius: 10px; margin-bottom: 10px; background: #ffffffb5;">
                        ...
                        <p style="margin: 5px 0 0; color: #555;font-size:17px">
                            <strong style="font-size:17x"><i class='bx bxs-dollar-circle' style='color:#1ab79d'></i> Price:</strong> {{ $offer->price }}$
                        </p>
                    </div>
                    @endforeach
                </div>
