...
<body id="top">
    ...
    <article>
      ...
      <section class="section blog has-bg-image" id="blog" aria-label="blog"
        ...
        <div class="container">
          ...
          <div>
            <a style="margin: auto; margin-top:20px" href="{{route('Servicehouse.Sections.Show.Client')}}" class="btn has-before"><span class="span">More Sections</span>
  ...
  @if(session('Success_Login_Client'))
    <script>
        Notiflix.Notify.success("{{ session('Success_Login_Client') }}");
    </script>
    @endif
</body>
