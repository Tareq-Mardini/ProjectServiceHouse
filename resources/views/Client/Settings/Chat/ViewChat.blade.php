        ...
        <main class="main-container">
            <ul class="client-list">
                ...
                <li class="client-item">
                    <a href="{{ url('ServiceHouse/Client/Settings/Chat/Supplier/' . $supplier->id) }}" class="client-link">
                        <img src="{{ Storage::url($supplier->image) }}" alt="ClientPhoto" class="client-image">
