  ...
  <section id="content">
    ...
    <nav>
      ...
      <div style="position: relative; display: inline-block;">
        <a style="color: white;" class="home-page" href="{{route('ServiceHouse.Home.Client')}}">
        ...
        <div id="actionMenu" style="display: none; position: absolute; right: 0; background-color: white; border-radius: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.1); z-index: 10; min-width: 150px;">
          <a href="{{ route('edit.wallet.clinet')}}" style="display: block; padding: 10px; color: black; text-decoration: none;">
            🔁 Data update
          </a>
          <a href="{{ route('client.balance', ['wallet_id' => $existingWallet->id]) }}" style="display: block; padding: 10px; color: black; text-decoration: none;">
            💰 Balance inquiry
          </a>
        </div>
      </div>
      ...
      <div style="margin: auto; height: fit-content;margin-top:100px; max-width:450px" class="container floating-card">
        ...
        <div class="card-details">
          <div class="name-number">
            ...
            <h5 class="name">{{$existingWallet->client->name}}</h5>
          </div>
