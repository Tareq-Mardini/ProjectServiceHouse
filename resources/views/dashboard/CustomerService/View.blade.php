    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <main style="height: 90%; margin-top:-20px" class="main-container">
                    <ul style="width: 95%; margin:auto;" class="client-list">
                        ...
                        <li class="client-item">
                            <a style="text-decoration: none;" href="{{ url('admin/dashboard/CustomerService/Supplier/'. $supplier->id) }}" class="client-link">
                                <img src="{{ Storage::url($supplier->image) }}" alt="supplierPhoto" class="client-image">
                                <div class="client-info">
                                    <span class="client-name">{{ $supplier->name }}<i style="font-size: 20px; margin-left:5px; color:red;" class='bx bx-message-dots chat-icon'></i></span>
                                </div>
                                <span style="color: green;" class="view-chat-text"><h6>Supplier</h6></span>
                            </a>
                        </li>
                        @endforeach
                        ...
                        <li class="client-item">
                            <a style="text-decoration: none;" href="{{ url('admin/dashboard/CustomerService/Client/'. $client->id) }}"w class="client-link">
                                ...
                                <span style="color: red;" class="view-chat-text"><h6>Client</h6></span>
                            </a>
                        </li>
                        @endforeach
                </main>
