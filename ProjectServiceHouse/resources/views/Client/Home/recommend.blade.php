...
<body id="top">
    ...
    <main>
        ...
        <div style="margin-top: 130px;text-align:center;" class="container">
            <h2 style="color: #ee4962;" class="text-3xl font-bold text-center mb-10 text-gray-800 animate-fade-in">
                <i style="color:#ee4962;" class="bx bxs-bulb text-yellow-500 mr-2"></i>
                Recommendations
            </h2>
